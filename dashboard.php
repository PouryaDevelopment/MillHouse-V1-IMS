...
<h1 class="text-4xl md:text-4xl lg:text-5xl font-bold text-white">
			...
			<ul class="lists" >
				...
				<li>
					<a href=""><i class="fa-solid fa-chart-simple"></i> <span class="textMenu"> Analytics</span></a>
				</li>
				<li class="./datamanagement.php">
					<a href=""><i class="fa-solid fa-magnifying-glass-chart"></i> <span class="textMenu"> Data Management</span></a>
				</li>
				<li class="">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-red-500 text-white p-4 rounded-lg shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-semibold">INVENTORY ALERTS</p>
       ...
       <div class="flex flex-wrap -mx-6">
            <div class="w-full md:w-1/2 lg:w-1/3 px-6 mb-6">
                <div class="p-8 bg-white rounded-lg shadow-lg h-full">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Top 5 Products</h2>
                    <div class="w-full h-64 bg-gray-200 rounded"></div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-6 mb-6">
                <div class="p-8 bg-white rounded-lg shadow-lg h-full">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Purchase and Sales Orders</h2>
                    <div class="w-full h-64 bg-gray-200 rounded"></div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-6 mb-6">
                <div class="p-8 bg-white rounded-lg shadow-lg h-full">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Shift Calender</h2>
                    <div class="w-full h-64 bg-gray-200 rounded"></div>
                </div>
            </div>
        </div>
