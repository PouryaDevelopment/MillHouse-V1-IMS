        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-6">
            ...
            <div class="bg-blue-500 text-white p-4 rounded-lg shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-semibold">TOTAL BEVERAGE COUNT</p>
            ...
            <div class="bg-yellow-500 text-white p-4 rounded-lg shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-semibold">TOTAL FOOD COUNT</p>
            ...
            <div class="bg-green-500 text-white p-4 rounded-lg shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-semibold">TOTAL INGREDIENT QUANTITY</p>
            ...
            <div class="bg-red-500 text-white p-4 rounded-lg shadow-lg">
                <div class="flex items-center">
                    ...
                    <div>
                        <p class="text-sm font-semibold">OVERALL</p>
                        <p class="text-3xl font-bold">85</p>
                    </div>
                </div>
            </div>
       ...
       <div class="flex flex-wrap -mx-6">
            <div class="w-full md:w-1/2 lg:w-1/3 px-6 mb-6">
                <div class="p-8 bg-white rounded-lg shadow-lg h-full">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Monthly ingredient usage</h2>
                    <div class="w-full h-64 bg-gray-200 rounded"></div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-6 mb-6">
                <div class="p-8 bg-white rounded-lg shadow-lg h-full">
                    <h2 class="text-2xl font-bold text-gray-800 mb-6">Yearly ingredient usage</h2>
                    <div class="w-full h-64 bg-gray-200 rounded"></div>
                </div>
            </div>
            <div class="w-full md:w-1/2 lg:w-1/3 px-6 mb-6">
